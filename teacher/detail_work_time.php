...
<body id="page-top" style="font-family: 'Kanit', sans-serif;">
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            ตาราง เวลาฝึกงาน
            <form method="post" action="export_detail_worktime.php?id=<?php echo $id=$_GET["id"];?>">
  ...
  WHERE student.branch_id = branch.branch_id AND student.std_id = work_time.std_id AND work_time.std_id ='$id'";
...
?>
                ...
                <tbody>
                  <tr>
                    ...
                    <th><a href="https://www.sbac.online/internship/teacher/map.php?lat=<?php echo $result["lat"]; ?>&lng=<?php echo $result["lng"]; ?>">ดูแผนที่</a></th>
