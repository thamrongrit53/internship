      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            ตารางบันทึกเวลาฝึกงาน / สัปดาห์ 
            <form method="POST" action="export_detail_week.php?id=<?php echo $id=$_GET["id"];?>">
...
?>
                ...
                <tbody>
                  <tr>
                    ...
                    <td><?php echo $result["wd_week"];?></td>
                    <td><?php echo $result["wd_first_day"];?></td>
                    <td><?php echo $result["wd_last_day"];?></td>
                    <td><?php echo $result["wd_dept"];?></td>
                    <td><?php echo $result["wd_job"];?></td>
                    <td><?php echo $result["wd_issue"];?></td>
                    <td><?php echo $result["wd_fix"];?></td>
                    <td><?php echo $result["wd_exp"];?></td>
                    <td><?php echo $result["wd_solve"];?></td>
                    <td><?php echo $result["wd_comment"];?></td>
