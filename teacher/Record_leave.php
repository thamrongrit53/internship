    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">การลาฝึกงาน</li>
        </ol>
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            ตารางการลา ฝึกงาน
            <form method="post" action="export_record_leave.php">
...
?>
                <tbody>
                  <tr>
                    ...
                    <td><?php echo $result["std_prefix"];?><?php echo $result["std_fname"];?>&nbsp;<?php echo $result["std_lname"];?></td>
                    <td><?php echo $result["std_class"];?></td>
                    <th><?php echo $result["branch_name"];?></th>
                    <td><?php echo $result["lev_type"];?></td>
                    <td><?php echo $result["lev_reason"];?></td>
                    <td><?php echo $result["lev_first_day"];?></td>
                    <td><?php echo $result["lev_last_day"];?></td>
                    <td><?php echo $result["lev_sum_day"];?></td>
                    <td><center>
       <a target="_blank" href="http://www.whalespace.com/internship/images/<?php echo $result["lev_attachment"];?>">
    <img src='../images/<?php echo $result["lev_attachment"];?>'id="img" class="img-thumbnail" style="width:200px;">
  
   </center> </td>
                    <td><span class="badge badge-warning"><?php if($result["lev_approved"] == 1){ echo "อนุมัติ";} else{ echo "ไม่อนุมัติ";}?></span>
                    <form action="update_status_lev.php?id=<?php echo $result["lev_id"];?>"method="POST">
                    <input type="radio" name="approve" value="0">ไม่อนุญาต<br>
                     <input type="radio" name="approve" value="1">อนุญาต <br>
