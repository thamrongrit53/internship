    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">บันทึกฝึกงาน</li>
        </ol>
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            <form method="post" action="export_record_intern.php" style="left:200px";>
...
?>
                ...
                <tbody>
                  <tr>
                    ...
                    <td><center><a href="detail_week.php?id=<?php echo $result["std_id"];?>" class="btn btn-primary">รายละเอียด</a></center></td>
<?php } ?>
