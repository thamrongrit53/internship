    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">ข้อมูลนักศึกษาฝึกงาน</li>
        </ol>

 <div class="card mb-3">
          <div class="card-header">
            <i class="fas fa-table"></i>
            ตาราง ข้อมูลนักศึกษาฝึกงาน
...
<td><center><?php echo $result["branch_name"];?></center></td>
<td><?php echo $result["std_address_num"];?>&nbsp; <?php echo $result["std_swine"];?>&nbsp; <?php echo $result["std_road"];?> &nbsp;<?php echo $result["std_canton"];?> &nbsp;<?php echo $result["std_district"];?> &nbsp;<?php echo $result["std_province"];?> &nbsp;<?php echo $result["std_zipcode"];?></td>
<td><center><?php echo $result["std_tel"];?></center></td>
<td align="center"><a href="detail_stu.php?id=<?php echo $result["std_id"];?>"class="btn btn-primary">ดูข้อมูล</a></td>
<td><a href="JavaScript:if(confirm('ยืนยันการลบ?')==true){window.location='delete_std.php?id=<?php echo $result["std_id"];?>';}" class="btn btn-danger">ลบข้อมูล</a></td>
</tr>
<?php       
}
?>
