...
<body id="page-top" style="font-family: 'Kanit', sans-serif;">
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            ตารางฝึกงานภายนอก 
            <form method="post" action="export_detail_timeout.php?id=<?php echo $id=$_GET["id"];?>">
  ...
  WHERE student.branch_id = branch.branch_id AND student.std_id = ext_intern.std_id AND ext_intern.std_id ='$id'";
